...
were replayed on both fresh artifacts: **6/6 PASS**. Manual final review found
both finals normal model-written reports after execution, with truthful scope
and test claims; neither was caller-rendered.
...
Sanitized counters, hashes and limits are in [RELEASE_ARTIFACTS.json](RELEASE_ARTIFACTS.json).
