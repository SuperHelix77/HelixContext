"""Luna High normal-final maintenance pair, versioned from native-output-v1."""
import hashlib
import json
import os
...
from bound_edit_tool import BoundEditTool, SPEC
...
def prepare(root):
    ...
    frozen = [Path(__file__), HERE / 'audit_native.py', HERE / 'test_bound_edit_tool.py', HERE / 'bound_edit_tool.py', HERE / 'PREREG.md', INPUT / 'TASK.md', INPUT / 'oracle.py', INPUT / 'OFFLINE_CALIBRATION.json',
