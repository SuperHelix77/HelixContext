...
# These relations were adjudicated for this exact contract and reference, not
# for arbitrary freshly hashed files. New contract/reference => new adjudication.
TASK_SHA256 = 'c827db4ca2733959ec621faa8c5411716086174fccfa978f72cb973afff4f507'
REFERENCE_SHA256 = '84d5c2ef22d8e6b2c1cea3ac110d9600f5854d7ca6d70477b5d5b62c9c18938d'
EVIDENCE_SHA256 = '40b13591bd7aa22480e55f71d4946ab09ef162a340da084b61d18f2d98a5cede'
...
def binding(before, candidate):
    if (sha(BASE / 'TASK.md') != TASK_SHA256 or sha(before) != REFERENCE_SHA256
            or sha(BASE / 'baseline/evidence.py') != EVIDENCE_SHA256
            or sha(inspect.getfile(Store)) != EVIDENCE_SHA256):
        raise ValueError('Unqualified relation contract/reference; semantic refresh required')
